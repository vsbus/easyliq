...
public class ActionServlet extends HttpServlet {
 private static final long serialVersionUID = 1L;
  ...
  if(request.getParameter("action") != null && request.getParameter("action") != "calculate")
  {
...
private void  Calculate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
{
    ...
    Boolean isInList = Boolean.parseBoolean(request.getParameter("isInList"));
    ...
    String json = "{\"Cm\":\""+Cm+"\", \"rho_s\":\""+rho_s+"\", \"rho_f\":\""+rho_f+"\", \"rho_sus\":\""+rho_sus+"\", \"Cv\":\""+Cv+"\", \"C\":\""+C+"\"}";
