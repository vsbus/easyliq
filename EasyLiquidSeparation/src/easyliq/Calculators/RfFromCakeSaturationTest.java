...
public class RfFromCakeSaturationTest {

	@Test
	public void testMoistureContentFromCakeSaturationEquation()
			throws Exception {
		...
		TestUtils
				.TestEquation(
						parameters,
						new easyliq.Calculators.RfFromCakeSaturation.MoistureContentFromCakeSaturationEquation());
	}
}
